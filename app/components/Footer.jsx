...
const Footer = () => {
  return (
    <footer className="footer bg-[#A31621] py-6">
      <Container1
        className={
          "md:!max-w-[98%] !max-w-[93%] rounded-xl bg-[#A31621] py-10 md:py-24 lg:py-32 !px-10 border-2 border-[#EAECC6] "
        }
      >
        <div className="grid  grid-cols-2 grid-rows-2 md:grid-rows-1  md:grid-cols-4 gap-x-10 gap-y-2 md:gap-4 text-[#FCF7F8]">
          ...
          <div className="2 flex flex-col items-center ju  gap-4 ">
            <h1 className="text-2xl md:text-3xl font-ox font-bold text-[#EAECC6] transition-all ease-in-out hover:text-[#FCF7F8] duration-300">
              Explore
            </h1>
            <ul className="text-base md:text-xl font-ox flex flex-col gap-1 md:gap-2">
          ...
          <div className="3  flex flex-col  j gap-4">
            <h1 className="text-2xl md:text-3xl font-ox font-bold text-[#EAECC6] transition-all ease-in-out hover:text-[#FCF7F8] duration-300">
              Socials
            </h1>
          ...
          <div className="1  flex flex-col items-center md:justify-center  gap-4">
            <h1 className="text-xl md:text-3xl font-semibold text-bil">
              Where <span className="text-[#EAECC6]">aesthetics</span> & <br />{" "}
              <span className="text-[#EAECC6]">functionality</span> meet
            </h1>
          </div>
        </div>
      </Container1>
